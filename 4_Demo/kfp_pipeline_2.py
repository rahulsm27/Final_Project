...
def load_data():
    return dsl.ContainerSpec(
        ...
        image = 'asia-south1-docker.pkg.dev/mlendtoend/artifact/load_data',
...
def display_stats():
    return dsl.ContainerSpec(
       # name= "Data processing",
        image = 'asia-south1-docker.pkg.dev/mlendtoend/artifact/display_stats',
        args = ['--data_path=kubeflow_demo'],
...
if __name__=='__main__':
    Compiler().compile(data_preprocessing, 'pipeline_2.yaml')